        ...
        <div className="terms-layout" style={{ display: 'flex', gap: 48, alignItems: 'flex-start' }}>
          ...
          <main ref={contentRef} style={{ flex: 1, minWidth: 0 }}>
            ...
            <section style={{ marginBottom: 48 }}>
              ...
              <P>The following types of listings are not permitted:</P>
              <UL>
            ...
            <section style={{ marginBottom: 48 }}>
              ...
              <P>The following types of job listings are not permitted:</P>
              <UL>
            ...
            <section style={{ marginBottom: 48 }}>
              ...
              <P>All holiday home listings must:</P>
              <UL>
            ...
            <section style={{ marginBottom: 48 }}>
              ...
              <P>To be eligible for a Verified Business Account, you must:</P>
              <UL>
            ...
            <section style={{ marginBottom: 48 }}>
              ...
              <P>Sellers who use the vehicle intermediary service agree to:</P>
              <UL>
