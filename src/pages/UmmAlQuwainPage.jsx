...
const residentialRentListings = [
  {
    ...
    location: 'The Pulse, Umm Al Quwain South',
    featured: true,
  },
  {
...
const residentialSaleListings = [
  ...
  },
  {
    ...
    details: '3 Beds · 3 Baths',
    location: 'Umm Al Quwain Opera Tower',
    featured: false,
  },
]
...
export default function UmmAlQuwainPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] font-sans text-dubizzle-dark">
      <Navbar city="Umm Al Quwain" onPostAd={() => setModalOpen(true)} />
      <Hero city="Umm Al Quwain" />
      <PromoBanners />
      <Categories />
