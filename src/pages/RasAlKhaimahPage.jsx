...
const residentialRentListings = [
  {
    ...
    location: 'The Pulse, Ras Al Khaimah South',
    featured: true,
  },
  {
...
const residentialSaleListings = [
  ...
  },
  {
    ...
    details: '3 Beds · 3 Baths',
    location: 'Ras Al Khaimah Opera Tower',
    featured: false,
  },
]
...
export default function RasAlKhaimahPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] font-sans text-dubizzle-dark">
      <Navbar city="Ras Al Khaimah" onPostAd={() => setModalOpen(true)} />
      <Hero city="Ras Al Khaimah" />
      <PromoBanners />
      <Categories />
